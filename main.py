...
player_ship = 'D:/Reza/kuliah/pbo/Starship_War/playership2.png'
enemy_ship = 'D:/Reza/kuliah/pbo/Starship_War/enemy_1.png'
enemy2_ship = 'D:/Reza/kuliah/pbo/Starship_War/enemy_2.png'
sideenemy_ship = 'D:/Reza/kuliah/pbo/Starship_War/enemy_3.png'
player_bullet = 'D:/Reza/kuliah/pbo/Starship_War/pbullet.png'
enemy_bullet = 'D:/Reza/kuliah/pbo/Starship_War/enemy_bullet.png'
sideenemy_bullet = 'D:/Reza/kuliah/pbo/Starship_War/enemy_side_bullet.png'

music = pygame.mixer.music.load('D:/Reza/kuliah/pbo/Starship_War/music.wav')
pygame.mixer.music.play(-1)
exp_sound = pygame.mixer.Sound('D:/Reza/kuliah/pbo/Starship_War/audio_explosion.wav')
laser_sound = pygame.mixer.Sound('D:/Reza/kuliah/pbo/Starship_War/audio_laser.wav')
gameover_sound = pygame.mixer.Sound('D:/Reza/kuliah/pbo/Starship_War/Game Over Theme.mp3')
...
class player(pygame.sprite.Sprite):
    ...
    def shoot(self):
        if self.activate_bullet:
            bullet = PlayerBullet('D:/Reza/kuliah/pbo/Starship_War/pbullet.png')
            mouse = pygame.mouse.get_pos()
...
class Enemy(player):
    ...
    def shoot(self):
        if self.rect.y in (0, 50, 200, 400):
            enemybullet = EnemyBullet('D:/Reza/kuliah/pbo/Starship_War/enemy_bullet.png')
...
class SideEnemy(Enemy):
    ...
    def shoot(self):
        if self.rect.x % 100 == 0:
            sideenemybullet = EnemyBullet('D:/Reza/kuliah/pbo/Starship_War/enemy_side_bullet.png')
...
class Game:
    def __init__(self):
        ...
        self.lives = 3
        self.score = 0
        self.font = pygame.font.Font('D:/Reza/kuliah/pbo/Starship_War/Pixeled.ttf',25)
        self.start_screen()

    def start_text(self):
        font = pygame.font.Font('D:/Reza/kuliah/pbo/Starship_War/ModernAesthetic-Personal.otf', 150)
        text = font.render('STARSHIP WAR', True, 'white')
        text_rect = text.get_rect(center=(s_width/2, s_height/2-80))
        screen.blit(text, text_rect)
        font1 = pygame.font.Font('D:/Reza/kuliah/pbo/Starship_War/ModernAesthetic-Personal.otf', 50)
        font2 = pygame.font.SysFont('Calibri', 20)
        text1 = font1.render('Click ENTER', True, 'grey')
        text2 = font2.render('KELOMPOK 5', True, 'white')
    ...
    def pause_text(self):
        font = pygame.font.Font('D:/Reza/kuliah/pbo/Starship_War/ModernAesthetic-Personal.otf', 100)
        ...
        if self.player.image.get_alpha() == 255:
            ...
            if hits:
                ...
                if self.lives < 0:
                        ...
                        my_font = pygame.font.Font("D:/Reza/kuliah/pbo/Starship_War/Pixeled.ttf",90)
